...
namespace BrainstormSessions
{
    public class Startup
    {
            ...
            IServiceProvider serviceProvider)
        {
            ...
            Log.Logger = new LoggerConfiguration().MinimumLevel.Debug().WriteTo.Console().WriteTo.Email(new EmailConnectionInfo
            {
                FromEmail = "buford.schroeder75@ethereal.email",
                ToEmail = "abzal8187@gmail.com",
                MailServer = "smtp.ethereal.email",
                NetworkCredentials = new NetworkCredential
                {
                    UserName = "buford.schroeder75@ethereal.email",
                    Password = "tSnVm9MSQWukAVWj2X",
                },
                Port = 587,
